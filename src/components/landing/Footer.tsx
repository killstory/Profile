  ...
  return <footer id="contact" className="bg-background text-foreground px-6 md:px-12 pt-24 lg:pt-32 pb-12">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-20">
          ...
          <a href="mailto:paramet.moon@gmail.com" className="group inline-flex items-center gap-3 px-10 py-5 bg-primary text-primary-foreground rounded-full font-bold text-xl hover:brightness-110 transition-all cursor-scale">
            Get in Touch
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-20">
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-3">
              {socials.map(social => <a key={social.name} href={social.href} target="_blank" rel="noopener noreferrer" className="group flex items-center gap-2 px-4 py-2.5 bg-muted/50 hover:bg-primary hover:text-primary-foreground rounded-full transition-all cursor-scale">
          ...
          <div>
            ...
            <div className="space-y-3">
              <a href="mailto:paramet.moon@gmail.com" className="flex items-center gap-3 text-foreground hover:text-primary transition-colors cursor-scale group">
              ...
              <a href="tel:+66819841878" className="flex items-center gap-3 text-foreground hover:text-primary transition-colors cursor-scale group">
                <span className="w-8 h-8 rounded-full bg-muted/50 flex items-center justify-center group-hover:bg-primary group-hover:text-primary-foreground transition-all">
                  <ArrowUpRight className="w-4 h-4" />
                </span>
